...
;copy translations end
  ...
  !define MUI_FILE "OpenCommandPromptHere"
  !define PRODUCT_VERSION "2.8"
  !define MUI_PRODUCT "4dots Software Open Command Prompt Here"
  !define PRODUCT_SHORTCUT "Open Command Prompt Here"
  !define MUI_ICON "cmd.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "4dots Software Open Command Prompt Here"
  OutFile "OpenCommandPromptHereSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\OpenCommandPromptHere" ""
...
;create start-menu items
  ...
  ;CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\${PRODUCT_SHORTCUT}Settings.lnk" "$INSTDIR\${MUI_FILE}Settings.exe" "" "$INSTDIR\${MUI_FILE}Settings.exe" 0
...
!endif
  ...
  !insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\OpenCommandPromptHereExt64.dll $SYSDIR\OpenCommandPromptHereExt.dll $SYSDIR
  SetRegView 64
...
${Else}
  ...
  !insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\OpenCommandPromptHereExt32.dll $SYSDIR\OpenCommandPromptHereExt.dll $SYSDIR

${EndIf}  

;ExecShell "open" $SYSDIR\regsvr32.exe" "$SYSDIR\OpenCommandPromptHereShellExt.dll /s"
...
;Add files
  SetOutPath "$INSTDIR"
  ;inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/OpenCommandPromptHere.php" "$PLUGINSDIR\Installmanager.exe" /end
  ;ExecWait "$PLUGINSDIR\Installmanager.exe 020" 

 Call IsDotNetInstalledAdv

  Delete $SYSDIR\OpenCommandPromptHereExt.dll 
  File "..\debug\${MUI_FILE}.exe"
  File "readme.txt"
...
;  File "open-command-prompt-here-150.png"
  ;File "OpenCommandPromptHereSettings.exe"
...
;  nsExec::Exec "$INSTDIR\net_updater32.exe --install win_opencommandprompthere.4dotssoftware.com"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\OpenCommandPromptHere" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\OpenCommandPromptHere" "InstallationDirectory" $INSTDIR
...
!endif
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\OpenCommandPromptHereExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;  nsExec::Exec "$INSTDIR\net_updater32.exe --uninstall win_opencommandprompthere.4dotssoftware.com" 
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\OpenCommandPromptHere"
  DeleteRegKey HKCU "Software\4dots Software\OpenCommandPromptHere"
...
Function .onInstSuccess
 ; MessageBox MB_OK "You have successfully installed ${MUI_PRODUCT}. Use the desktop icon to start the program."
   ExecShell "" "http://www.4dots-software.com/open-command-prompt-here/?afterinstall=true&version=${PRODUCT_VERSION}";
FunctionEnd
...
Function .onInit
  ...
  ;StrCpy $RevenyouProduct "Open+Command+Prompt+Here";  
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/open-command-prompt-here/?afterinstall=true"
FunctionEnd
;eof
